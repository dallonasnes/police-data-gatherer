...
def cops_subset(start_idx: int, count: int):
    ...
    if end_idx < len(active_cops_with_data):
        response["cops"] = jsonable_encoder(active_cops_with_data[start_idx:end_idx])
        return response
    elif start_idx < len(active_cops_with_data):
        response["cops"] = jsonable_encoder(active_cops_with_data[start_idx:])
        return response
    else:
